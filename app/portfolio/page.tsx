      ...
      <Section className="relative z-10 py-16 md:py-24">
        <Container>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center mb-12">
            <Heading level={1} className="mb-4 gradient-text text-shine">My Projects</Heading>
            <Text size="lg" className="max-w-2xl mx-auto text-gray-300">Professional products I&apos;ve tested and validated end-to-end</Text>
          </motion.div>
